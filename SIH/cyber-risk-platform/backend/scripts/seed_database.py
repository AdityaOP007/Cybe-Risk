...
def seed_organization(db: Session):
    ...
    db.flush()
    logger.info("✓ Organization 'Example Bank' created.")
...
def seed_predictions(db: Session):
    ...
    for asset_def in ASSETS:
        ...
        confidence = max(60, risk.metadata_.get("confidence", 80) - 10) if risk.metadata_ else 70
